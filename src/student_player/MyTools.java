...
public class MyTools
{
    ...
    public static       int TURN_TO_INCREASE_DEPTH      = 10; // found by trial and error
    public static    double COST_MULTIPLIER_WHEN_BLACK  = 1; // White higher chance of winning: defend more if Black
    public static       int POTENTIAL_WIN_COST          = Integer.MAX_VALUE/2;
    public static       int WIN_COST                    = Integer.MAX_VALUE/2;
    public static       int SINGLES_COST                = 6;
    public static       int TWO_CONSEC_COST             = 20;
    public static       int THREE_CONSEC_COST           = 80;
    public static       int FOUR_CONSEC_COST            = 1600;
    public static       int FIVE_CONSEC_COST            = Integer.MAX_VALUE/4;
    public static final int FOUR_IN_SAME_RANGE          = 10;
    public static final int SIM_TIME_LIMIT              = 800;
    public static final int CHOOSE_MOVE_TIME_LIMIT      = 1920;
